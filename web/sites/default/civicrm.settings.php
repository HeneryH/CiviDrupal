...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://civi:C0lleen#1@localhost:3306/civi?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civi:C0lleen#1@localhost:3306/civi?new_link=true');
  }
}
...
$civicrm_root = '/var/www/rotary1/vendor/civicrm/civicrm-core';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/rotary1/web/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civid8');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'b52b785804a344bbb028eeb1a60565c5');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/rotary1/web/sites/default/files/civicrm/templates_c//mail.log');
// }
